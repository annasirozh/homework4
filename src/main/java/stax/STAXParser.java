...
public class STAXParser {
    public static void main(String[] args) throws XMLStreamException {
            ...
            switch (event) {
                ...
                case XMLStreamConstants.END_ELEMENT:
                    switch (reader.getLocalName()) {
                        case "journal":
                            journalTitleList.add(currJournalTitle);
                        case "journal_title":
                            currJournalTitle.setJournal_title(tagContent);

                        case "contacts":
                            contactsList.add(currContacts);
                        case "address":
                            currContacts.setAddress(tagContent);
                        case "tel":
                            currContacts.setTel(tagContent);
                        case "email":
                            currContacts.setEmail(tagContent);
                        case "journal_url":
                            currContacts.setJournal_url(tagContent);

                        case "articles":
                            articleList.add(currArticle);
                        case "ID":
                            currArticle.setId(tagContent);
                        case "title":
                        ...
                        case "hotkeys":
                            hotkeysList.add(currHotkeys);
                        case "hotkey":
                            currHotkeys.setHotkey(tagContent);
                    }
                    break;
       ...
       for (Contacts contact : contactsList) {
        ...
        for (Hotkeys hotkey : hotkeysList) {
